...
class _LoginState extends State<LoginPage> {
          ...
          Form(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: <Widget>[
                ...
                RichText(
                  text: TextSpan(style: const TextStyle(color: Colors.grey, fontSize: 20.0), children: <TextSpan>[
  ...
  void _loginUser() async {
    ...
    if (loginResponse.user != null && loginResponse.success == true && loginResponse.user?.isEmployer == false) {
      _saveAndRedirectToCheckPin();
    } else {
      final message =
          (loginResponse.message == "User successfully Loggedin.") ? "User Doesn't Exist" : loginResponse.message ?? 'Please try again later';
