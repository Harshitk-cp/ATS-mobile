                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    const Spacer(),
                                    Text(
                                      "₹ ${Utility.formatNumberIndianStyle(snapshot.data?[index]['salaryRange'].toDouble() ?? 0)}",
                                      style: const TextStyle(
                                        color: Colors.white,
                                        fontSize: 15,
                                        fontWeight: FontWeight.bold,
