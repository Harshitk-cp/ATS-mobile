                ...
                child: Column(
                  children: [
                    ...
                    ...[
                      ...
                      _buildListTile(Icons.currency_rupee_rounded,
                          'Salary Range: \₹${job['salaryRange']}'),
                      _buildListTile(Icons.person,
                          'No. of Positions: ${job['noOfPositions']}'),
                      _buildListTile(
                          Icons.school, 'Education: ${job['education']}'),
                      _buildListTile(
                          Icons.work, 'Experience: ${job['experience']}'),
                      _buildListTile(Icons.playlist_add_check,
                          'No. of Rounds: ${job['noOfRounds']}'),
                        ...
                        child: Align(
                          ...
                          child: Container(
                            ...
                            child: Align(
                              alignment: Alignment.center,
                              child: Text(
                                list.contains(user.user?.id.toString())
                                    ? 'Already Applied'
                                    : 'Apply',
                                style: const TextStyle(
                                  fontSize: 16,
